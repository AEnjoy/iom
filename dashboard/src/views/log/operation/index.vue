        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="操作状态：">
              {{ state.modelForm.status ==='1' ? '成功' : '失败' }}
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
function listOperInfo(queryParams: any) {
  return axios.get("/api/log/logOper/list?pageNo="+queryParams.pageNo+"&pageSize="+queryParams.pageSize
      +"&title="+queryParams.title+"&operName="+queryParams.operName+"&businessType="+queryParams.businessType)
}
...
function cleanOpernfo() {
  return axios.delete("/api/log/logOper/all");
}
...
function delOperInfo(operIds: any) {
  return axios.delete("/api/log/logOper/remove/" + operIds);
}
